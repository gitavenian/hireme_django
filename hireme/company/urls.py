...
urlpatterns = [
    ...
    path('branch/<int:branch_id>/filter_users/', filter_users, name='filter_users'),
    path('skills_by_branch/<int:branch_id>/', get_skills_by_branch_job_nature, name='skills_by_branch'),
]
